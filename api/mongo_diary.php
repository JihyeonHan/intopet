...
$user_idx = 0;
$query_user = "SELECT * FROM itapp_user WHERE user_id = '".$user_id."' AND old_schedule_yn is null ";
...
<?    } 
      ...
      foreach( $diarys as $diary ){
            ...
            $query_exists_cont = "SELECT * FROM itapp_schedule WHERE old_id = '".$diary["_id"]."' ";
      ...
      $query_end_update = " UPDATE `intopet`.`itapp_user` SET old_schedule_yn = '".date("Y-m-d H:i:s")."'
                              WHERE idx = '".$user_idx."' ";
