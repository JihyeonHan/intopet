...
$land_url = "http://app2.intopet.co.kr/app/php/lounge/story/story_cont_view.php?idx=107763";//"http://app2.intopet.co.kr/app/php/lounge/story/story_cont_view.php?idx=1604";
$token = $fcmtoken;
...
$notification = array('title'=>$title,'body'=>$message,'url'=>$land_url,'img_noti'=>'http://app.intopet.co.kr/ID5948eacc00ee755a3f791d73/20200227055452415_tmp_1320617560.png');
$tokens = array();
$tokens[0] = $toden;
...
$fields = array('to'=>$token,'priority'=>'high','content_available'=>true,'mutable_content'=>true,'notification'=>$notification);
